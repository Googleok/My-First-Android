...
class Thr3 extends AsyncTask <Void, Void, Void> {

    private SubTitle3 st;  //SubTitle 클래스
    private ButtonClass3 bc;  // ButtonClass 클래스
    private WhenAmanLoveIsWomenActivity.YouTube mt;  // innerclass인 Youtube 클래스

    Thr3(SubTitle3 st, ButtonClass3 bc, WhenAmanLoveIsWomenActivity.YouTube mt)
    {
...
class ButtonClass3 {
    ...
    ButtonClass3(final Activity myActivity, final WhenAmanLoveIsWomenActivity whenAmanLoveIsWomenActivity) {
        ...
        song="When a man loves woman";
        singer="Michael Bolton";
        image=R.drawable.whenaman;
...
public class WhenAmanLoveIsWomenActivity extends YouTubeBaseActivity {

    private YouTube youTube = null;
    private ButtonClass3 bc = null;
    private SubTitle3 st = null;
    private Thr3 thr = null;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bc = new ButtonClass3(this, this); // 레이아웃( 텍스트뷰와 버튼2개) 클래스
        st = new SubTitle3(this); // 스피너, 자막 관리 클래스
        thr = new Thr3(st, bc, youTube); // asynkTask
    ...
    class YouTube implements YouTubePlayer.Provider {
        ...
        public static final String VIDEO_ID = "JmfOzFzYumo";    // 넣고자 하는 영상 주소
